...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		assertNull("There is no Cat", r.getCat(2));
	...
	public void testListCatsNumCats3() {
		// TODO
		// Cat c1 = new Cat(1, "Jennyanydots");
		// Cat c2 = new Cat(2, "Deuteronomy");
		// Cat c3 = new Cat(3, "Mistoffelees");
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
		String mycats = r.listCats();		
		//r.listCats();
		assertEquals("ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", mycats.toString());//r.listCats());
	...
	public void testReturnCatFailureNumCats0() {
		// TODO
		assertFalse("no cat", r.returnCat(2));
	}
	...
	public void testReturnCatNumCats3() {
		...
		//r.returnCat(2);
		//Mockito.verify(c2, Mockito.times(1)).getId();
		...
		//Mockito.when(r.returnCat(2)).thenReturn(true);
		c2.returnCat();
		//assertTrue("2 is returned", r.catAvailable(2));
		//r.returnCat(2);
