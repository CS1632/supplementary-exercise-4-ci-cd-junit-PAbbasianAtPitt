...
public class RentACatImpl implements RentACat {
    ...
    public boolean returnCat(int id) {
        ...
        // TODO
        Cat c = getCat(id);
        if (catExists(id) && c.getRented()) {//c != null && c.getRented()) {
            c.returnCat();
            return true;
        }else{
            return false;
    ...
    public String listCats() {
        ...
        // return ret;
        String myList = ""; // declare and initialize myList variable
		// if(cats == null)
		// {
		// 	return null;
		// }
		...
		else
		{
			for(Cat myCat: cats)
			{
				//System.out.println("this cat is not rented: " + myCat.getName());
				if(!myCat.getRented())
				{
					myList += "ID " + myCat.getId() + ". ";
					myList += myCat.getName().toString();
					myList += "\n";
				}
				// if(myList == "")
				// {
